const benefits = [
  {
    ...
    description: "Cada produto foi criado para resolver um problema real com elegância.",
    icon: (
  ...
  },
  {
    ...
    description: "Estética atemporal que combina com qualquer decoração e não sai de moda.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Atenção aos detalhes em cada produto. Feito com cuidado e precisão.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: "Simplicidade no dia a dia",
    description: "Menos é mais. Produtos que simplificam e embelezam o cotidiano.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function Benefits() {
  return (
    <section
      className="py-24 lg:py-32 bg-[#E8E2D9]"
